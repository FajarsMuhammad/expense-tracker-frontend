      ...
      <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden ring-1 ring-gray-100">
        ...
        <div class="px-8 py-6 bg-gradient-to-r from-primary-50 to-white">
          <div class="flex items-center justify-center gap-3">
            ...
            <div class="text-center">
              ...
              <p class="text-sm text-gray-500">Securely manage your expenses</p>
            </div>
          </div>
        </div>
        ...
        <div class="px-8 py-8">
          ...
          <form @submit.prevent="onSubmit" class="space-y-4">
            <AppInput id="email" v-model="email" type="email" label="Email" placeholder="you@example.com" required
              :error="errors.email" />
            ...
            <div>
              ...
              <div class="relative">
                <AppInput v-model="password" :type="showPassword ? 'text' : 'password'"
                  placeholder="Enter your password" class="pr-10" :error="errors.password" />
        ...
        <div class="px-8 py-6 bg-gray-50">
          ...
          <div class="flex items-center gap-3 my-4">
            ...
            <div class="text-xs text-gray-400">Or continue with</div>
            <div class="flex-1 h-px bg-gray-200"></div>
          </div>
          ...
          <div class="flex items-center justify-center gap-4 py-1">
            ...
            <button @click="onOAuth('facebook')" :disabled="oauthLoading.facebook || loading"
              ...
              style="background-color: #1877F2;" aria-label="Login with Facebook">
              <svg class="w-5 h-5" fill="white" viewBox="0 0 24 24">
                <path
