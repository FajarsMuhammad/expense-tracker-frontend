  ...
  <div class="space-y-4">
    ...
    <div class="flex flex-wrap gap-1.5 sm:gap-2">
      <button
        ...
        :key="preset.value"
        type="button"
        class="rounded-lg border px-2.5 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium transition-all duration-200"
        :class="
      ...
      >
        <CalendarIcon class="mr-1 sm:mr-1.5 inline size-3 sm:size-4" />
        Custom
      </button>
    </div>
    ...
    >
      <div
        ...
        class="rounded-lg border border-neutral-200 bg-white p-3 sm:p-4 shadow-sm dark:border-neutral-700 dark:bg-dark-card"
      >
        <div class="grid gap-3 sm:gap-4 sm:grid-cols-2">
          <!-- Start Date -->
          <div>
            <label class="mb-1.5 sm:mb-2 block text-xs sm:text-sm font-medium text-neutral-700 dark:text-neutral-300">
              Start Date
            </label>
            <input
        ...
        <div class="mt-3 sm:mt-4 flex gap-2">
          <button
            type="button"
            class="flex-1 rounded-lg bg-primary-600 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-white transition-colors hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500/50 dark:bg-primary-500 dark:hover:bg-primary-600"
          ...
          <button
            type="button"
            class="rounded-lg border border-neutral-300 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50 dark:border-neutral-600 dark:text-neutral-300 dark:hover:bg-neutral-800"
    ...
    <div
      ...
      class="flex items-center justify-between rounded-lg bg-neutral-50 p-2 sm:p-3 dark:bg-neutral-800/50"
    >
      <div class="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm min-w-0">
        <CalendarIcon class="size-3 sm:size-4 flex-shrink-0 text-neutral-600 dark:text-neutral-400" />
      ...
      <button
        v-if="allowClear"
        type="button"
        class="rounded p-1 flex-shrink-0 text-neutral-500 transition-colors hover:bg-neutral-200 hover:text-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-200"
        @click="clearDates"
      >
        <XMarkIcon class="size-3 sm:size-4" />
      </button>
    </div>
  </div>
</template>
